...
import mentoring.GurhanRecap.GurhanMethods;

import static mentoring.GurhanRecap.GurhanMethods.*;
...
//        }
//        }
        GurhanMethods bobs = new GurhanMethods();
        System.out.println(isPalindrome("bobby"));
        System.out.println(GurhanMethods.mon);
    }
}
